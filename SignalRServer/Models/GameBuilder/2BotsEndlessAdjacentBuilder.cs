...
namespace SignalRServer.Models
{
    ...
    public class EndlessAdjacentGameBuilder : IGameBuilder
{
    ...
    public EndlessAdjacentGameBuilder(Facade facade)
    {
        _facade = facade;
    }
    ...
    public async Task<AbstractGame> GetResultAsync()
    {
        await _facade.JoinRoom(
            ...
            botAmount: 2,
            gameMode: "Endless",
            cardPlacementStrategy: "AdjacentNumberPlacementStrategy"
        );
